...
int main()
{
    ...
    sf::CircleShape landingZone1(15.f);
    landingZone1.setFillColor(sf::Color::Green);
    landingZone1.setOrigin(sf::Vector2f(15,15));
    landingZone1.setPosition(sf::Vector2f(249,138));
